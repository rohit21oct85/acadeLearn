...
<p>Candidates / Students are requested to take the test honestly, ethically while following all instructions. </p>
                  ...
                  <div class="test_assign_hlp pt-0">
...
<li>However, please remember that if you fail to answer all the questions within the test duration hours, the timer will automatically submit your test application.</li>
  ...
  <li>Students SHOULD NOT FORGET TO CLICK on the ‘Finish’ button after completing the test.</li>
              ...
              <div class="accepted_dv"> <input type="checkbox" id="vehicle1" name="accepted">
  <label for="accepted"> “I am [student_name], and I have read and hereby accepted all the instructions mentioned above. I therefore want to open the test portal and my 03:00 hours test duration will start from now on.”</label>

                  <button class="start_now_btn btn btn-warning btn-min-width sbmt_view_form btn_click2 mr-1 mb-1 mt-2">Start Now</button>
