                ...
                <div className="navbar-wrapper">
                    ...
                    <div className="navbar-container content">
                        <div className="collapse navbar-collapse" id="navbar-mobile">
                            ...
                            <li className={`dropdown dropdown-user nav-item ${showDrop}`} onClick={changeDrop}><a className="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span className="mr-1 user-name text-bold-700">John Doe</span><span className="avatar avatar-online"><img src="/images/portrait/small/avatar-s-19.png" alt="avatar"/><i></i></span></a>
